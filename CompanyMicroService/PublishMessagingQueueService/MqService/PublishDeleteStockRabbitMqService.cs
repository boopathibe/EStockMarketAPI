...
{
    public class PublishDeleteStockRabbitMqService : IPublishDeleteStockRabbitMqService
    {
        ...
        public PublishDeleteStockRabbitMqService(IConfiguration configuration)
        {
        ...
        public void SendDeleteCompanyMessage(string deleteCompanyCode)
        {
            if (ConnectionExists())
            {
                ...
                channel.BasicPublish(exchange: null, routingKey: _queueName, basicProperties: null, body: body);
            }
        }
